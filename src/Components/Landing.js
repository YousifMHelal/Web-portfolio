...
const Landing = ({ theme }) => {
  ...
  return (
    <div className="container mx-auto max-w-[1172px] px-4" id="home">
      <div
        className="min-h-[750px] flex items-center justify-between 
        ...
        <div className="flex max-md:mt-20">
          ...
          <div className="flex flex-col mr-8">
            <a href="/">
              <FaFacebook
                className="text-3xl mb-8 text-light-p dark:text-dark-h cursor-pointer 
          ...
          <div>
            {/* -----My information----- */}
            <p className="dark:text-dark-p2 text-light-p text-3xl">
              Hi, my name is
            </p>
            <h1 className="bg-gradient-to-r from-start-blue to-end-blue bg-clip-text text-6xl py-2 font-bold heading">
              Emily Turner
            </h1>
            <h2 className="text-3xl text-light-p dark:text-dark-p2">
              I'm a{" "}
              <span className="bg-gradient-to-r from-start-red to-end-red bg-clip-text text-4xl font-bold heading">
                Full-Stack
              </span>{" "}
              developer
            </h2>
        ...
        <div
          className="w-[486px] h-[300px] border border-dark-p2 overflow-hidden relative rounded-[5px] border-solid bg-dark-bg
          ...
          <div className="absolute text-light-p dark:text-dark-p w-full h-[30px] flex items-center border-b-[color:var(--dark-p2)] px-2.5 py-0 border-b border-solid top-0">
            ...
            <div
              className="text-xs h-full border-b-light dark:border-b-dark border-l-dark-p2 border-r-dark-p2
                        mx-2.5 my-0 pt-2.5 pb-5 px-2.5 border-b-[5px] border-solid border-l border-r dark:bg-dark">
              App.js
            </div>
          </div>
          {/* -----code page writer----- */}
          <div className="absolute text-light-h dark:text-dark-h h-[calc(100%_-_30px)] w-[calc(100%_-_35px)] text-sm p-2 right-0 bottom-0">
            <p>
              <span className="text-end-red">import</span> React{" "}
              <span className="text-end-red">from</span> "react";
            </p>
            <br />
            {/* -----Code display----- */}

            <pre>
              &#32;<span className="text-end-red">function</span> App
              <span className="text-end-red">() &#123;</span>
              <br /> return (
              <br /> <span className="text-end-blue">&lt;h1&gt;</span>
              {text}
              <span className="text-end-blue"> &lt;/h1&gt;</span>
              <br /> )
